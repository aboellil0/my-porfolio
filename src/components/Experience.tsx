...
const Experience = () => {
  ...
  const professionalTitleAnimation = useScrollAnimation<HTMLHeadingElement>({
    delay: 200,
  });
  const volunteerTitleAnimation = useScrollAnimation<HTMLHeadingElement>({
    delay: 300,
  });
  ...
  const professionalExperience = [
    {
      ...
      period: "2024 – 2025",
      description:
        "Led a web development team, managed projects for student applications, and conducted backend workshops for over 50 students.",
    ...
    },
    {
      ...
      period: "2 years",
      description:
        "Delivered custom backend solutions for clients using .NET Core, Node.js focusing on CRUD systems, database design, and secure authentication.",
  ...
  const professional1Animation = useScrollAnimation<HTMLDivElement>({
    delay: 250,
  });
  const professional2Animation = useScrollAnimation<HTMLDivElement>({
    delay: 400,
  });

  const professionalAnimations = [
    professional1Animation,
    professional2Animation,
  ];

  const volunteer1Animation = useScrollAnimation<HTMLDivElement>({
    delay: 350,
  });
  const volunteer2Animation = useScrollAnimation<HTMLDivElement>({
    delay: 450,
  });
  ...
  return (
    <section
      id="experience"
      className="py-20 bg-gray-50 dark:bg-dark-800 transition-colors duration-300 relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="mb-16">
          <h3
            ref={professionalTitleAnimation.ref}
            className={`text-2xl font-bold text-gray-900 dark:text-white mb-8 flex items-center ${professionalTitleAnimation.animationClasses}`}
          >
        ...
        <div>
          <h3
            ref={volunteerTitleAnimation.ref}
            className={`text-2xl font-bold text-gray-900 dark:text-white mb-8 flex items-center ${volunteerTitleAnimation.animationClasses}`}
          >
