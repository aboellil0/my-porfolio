...
const Certifications = () => {
  ...
  const cert4Animation = useScrollAnimation<HTMLDivElement>({ delay: 500 });
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {certifications.map((cert, index) => (
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div
                  className={`p-3 rounded-full ${getCategoryIcon(
                    cert.category
                  )}`}
                >
                  {cert.icon}
        ...
        <div
          ...
          className={`mt-12 text-center ${languagesAnimation.animationClasses}`}
        >
