...
const Skills = () => {
  ...
  const skillCard1Animation = useScrollAnimation<HTMLDivElement>({
    delay: 200,
  });
  const skillCard2Animation = useScrollAnimation<HTMLDivElement>({
    delay: 300,
  });
  const skillCard3Animation = useScrollAnimation<HTMLDivElement>({
    delay: 400,
  });
  const skillCard4Animation = useScrollAnimation<HTMLDivElement>({
    delay: 500,
  });
  const skillCard5Animation = useScrollAnimation<HTMLDivElement>({
    delay: 600,
  });
  const skillCard6Animation = useScrollAnimation<HTMLDivElement>({
    delay: 700,
  });
  ...
  return (
    <section
      id="skills"
      className="py-20 skills-animated-bg transition-colors duration-300 relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-4xl font-bold bg-gradient-to-r from-dark-800 dark:from-white to-primary-600 bg-clip-text text-transparent mb-4 animate-text-shimmer bg-shimmer bg-200%">
            Technical Skills
          </h2>
        ...
        <div
          ref={conceptsAnimation.ref}
          className={`bg-white/80 dark:bg-dark-800/80 backdrop-blur-sm p-10 rounded-2xl shadow-2xl dark:shadow-2xl dark:shadow-primary-500/10 border border-gray-100 dark:border-dark-700 relative overflow-hidden ${conceptsAnimation.animationClasses}`}
        >
