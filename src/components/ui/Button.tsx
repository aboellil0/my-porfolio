...
const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    ...
    secondary: 'bg-gradient-to-r from-dark-700 to-dark-800 hover:from-dark-800 hover:to-dark-900 text-white shadow-lg hover:shadow-xl',
    outline: 'bg-white/10 backdrop-blur-md border-2 border-white/30 text-white hover:bg-white/20 hover:border-white/50',
